...
export const MAP_ZONES: MapZone[] = [
  {
    ...
    markerBg: '#ddeeff',
    position: { x: 18, y: 28 },
    scenarioIds: ['S001', 'S006', 'S012', 'S014', 'S020', 'S021'],
  ...
  },
  {
    ...
    markerBg: '#fff4e6',
    position: { x: 30, y: 78 },
    scenarioIds: ['S003', 'S009', 'S018', 'S024'],
  ...
  },
  {
    ...
    markerBg: '#ddeeff',
    position: { x: 52, y: 50 },
    scenarioIds: ['S007', 'S013', 'S015', 'S016', 'S017', 'S022'],
